...
var tls_cache = utls.NewLRUClientSessionCache(0)

var underlying fasthttp.DialFunc = func(addr string) (net.Conn, error) {
...
func utls_dial(addr string) (net.Conn, error) {
	...
	// ff 148 with some small tweaks :P
...
func init() {
	...
	if cfg.SpoofTLS {
		httpc.Dial = utls_dial
		genericClient.Dial = utls_dial
	}
